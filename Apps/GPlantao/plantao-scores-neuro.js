function scoreConfigsNeuro() {
  ...
  configs.push({
    ...
    result: function (s) {
      ...
      return {
        summary: total + "/15 - " + risk,
        text: "- Glasgow: " + total + "/15 (" + risk + ")."
      };
    }
  });
  configs.push({
    ...
    result: function (s) {
      ...
      var risk =
        total <= 5 ? "leve" : total <= 15 ? "moderado" : total <= 20 ? "moderado-grave" : "grave";
      return {
        summary: total + "/42 - " + risk,
        text: "- NIHSS: " + total + "/42 (" + risk + ")."
      };
    }
  });
  configs.push({
    ...
    result: function (s) {
      ...
      var risk = total
        ? high
          ? "TC indicada - alto risco"
          : "considerar TC - medio risco"
        : "sem criterio pelo CCHR";
  ...
  configs.push({
    ...
    result: function (s) {
      ...
      return {
        summary: total + " criterio(s) - " + risk,
        text: "- New Orleans Criteria: " + total + " criterio(s) (" + risk + ")."
      };
    }
  });
  configs.push({
        ...
        total <= 8
          ...
          : total <= 15
            ...
            : total <= 20
              ...
              : "grave";
      return {
        summary: total + "/67 - abstinencia " + risk,
        text: "- CIWA-Ar: " + total + "/67 (abstinencia " + risk + ")."
      };
    }
  });
