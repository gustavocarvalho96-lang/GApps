    ...
    result: function (s) {
      ...
      var risk =
        total <= 4
          ? "baixa probabilidade"
          : total <= 6
            ? "compatível/observacao"
            : total <= 8
              ? "provavel"
              : "muito provavel";
      return {
        summary: total + "/10 - " + risk,
        text: "- Alvarado: " + total + "/10 (" + risk + ")."
      };
    }
  });
  configs.push({
    ...
    result: function (s) {
      ...
      return {
        summary: total + " pts - risco " + risk,
        text: "- Centor/McIsaac: " + total + " pts (risco " + risk + " para estreptococo)."
      };
    }
  });
  configs.push({
    ...
    result: function (s) {
      ...
      return {
        summary: total + "/5 - risco " + risk,
        text: "- BISAP: " + total + "/5 (risco " + risk + " em pancreatite aguda)."
      };
    }
  });
  configs.push({
    ...
    result: function (s) {
      ...
      return {
        summary: total + "/5 admissao - risco " + risk,
        text:
          "- Ranson na admissao: " +
          total +
          "/5 (risco " +
          risk +
          "; completar criterios em 48h se internado)."
      };
    }
  });
  configs.push({
