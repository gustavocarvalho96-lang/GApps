function scoreConfigsTev() {
  ...
  configs.push({
    ...
    result: function (s) {
      ...
      return {
        summary: total + " pts - " + risk,
        text: "- Wells TEP: " + total + " pts (" + risk + ")."
      };
    }
  });
  configs.push({
  ...
  configs.push({
    ...
    fields: [
      ...
      { type: "yesno", key: "prior", label: "TVP previa" },
      {
        type: "option",
        key: "alternative",
        label: "Diagnostico alternativo tao provavel",
        options: [
          ["0", "Nao"],
          ["-2", "Sim (-2)"]
        ]
    ...
    result: function (s) {
      ...
      return {
        ...
        text: "- Wells TVP: " + total + " pts (risco " + risk + ")."
      };
    }
  });
  configs.push({
  ...
  configs.push({
    ...
    result: function (s) {
      var total =
        (Number(s.age) || 0) +
        scoreSum(s, ["male", "cancer", "hf", "lung", "hr", "bp", "temp", "rr", "sat", "mental"]);
      var risk =
        total <= 65
          ? "classe I"
          : total <= 85
