function scoreConfigsRespiratorio() {
  ...
  configs.push({
    ...
    result: function (s) {
      ...
      var anyThree = ["rr", "spo2", "sbp", "pulse", "mental", "temp"].some(function (key) {
        return Number(s[key] || 0) === 3;
      });
      var risk =
        total >= 7
          ? "alto"
  ...
  configs.push({
    ...
    result: function (s) {
      ...
      return {
        ...
        text: "- CURB-65: " + total + "/5 (risco " + risk + ")."
      };
    }
  });
  configs.push({
    ...
    result: function (s) {
      ...
      return {
        summary: total + " pts - " + klass + " / risco " + risk,
        text: "- PSI/PORT: " + total + " pts (" + klass + ", risco " + risk + ")."
      };
    }
  });
